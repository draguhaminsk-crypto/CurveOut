    ...
    async function loadPublicDecks() {
      ...
      const [
        ...
        commanderIds.length > 0
          ? supabase
              .from("cards")
              .select("scryfall_id, name, image_uri, image_uri_large")
                  ...
                  <div className="relative h-44 overflow-hidden bg-white/[0.02]">
                    {image ? (
                      <img
                        ...
                        className="h-full w-full object-cover object-[center_28%] transition duration-500 group-hover:scale-[1.025]"
                      />
                    ) : (
